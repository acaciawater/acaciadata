# -*- coding: utf-8 -*-
# Generated by Django 1.11.18 on 2019-12-04 16:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groundLevelStable', acacia.meetnet.bro.fields.IndicationYesNoUnknownEnumeration(max_length=20)),
                ('wellStability', acacia.meetnet.bro.fields.IndicationYesNoUnknownEnumeration(max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artesianWellCapPresent', acacia.meetnet.bro.fields.IndicationYesNoUnknownEnumeration(max_length=20)),
                ('sedimentSumpPresent', acacia.meetnet.bro.fields.IndicationYesNoUnknownEnumeration(max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('requestReference', models.CharField(default='Verzoek voor put %s', max_length=100, verbose_name='requestReference')),
                ...
                ('underPrivilege', acacia.meetnet.bro.fields.IndicationYesNoUnknownEnumeration(max_length=20)),
                ('gmw', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bro.GroundwaterMonitoringWell', verbose_name='GroundwaterMonitoringWell')),
            ],
            options={
